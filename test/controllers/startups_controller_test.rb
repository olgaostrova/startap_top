...
class StartupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create startup" do
    assert_difference("Startup.count") do
      post startups_url, params: { startup: { User_id: @startup.User_id, author_name: @startup.author_name, description: @startup.description, name: @startup.name, tags: @startup.tags } }
    end
  ...
  test "should update startup" do
    patch startup_url(@startup), params: { startup: { User_id: @startup.User_id, author_name: @startup.author_name, description: @startup.description, name: @startup.name, tags: @startup.tags } }
